...
class DetailSKCKDiajukan2 extends StatefulWidget {
  const DetailSKCKDiajukan2({super.key});

  @override
  State<DetailSKCKDiajukan2> createState() => _DetailSKCKDiajukan2State();
}

class _DetailSKCKDiajukan2State extends State<DetailSKCKDiajukan2> {
  @override
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        Colors.grey, // Warna abu-abu untuk tombol "Disetujui"
                    minimumSize: const Size(170, 40),
                    foregroundColor: Colors.black,
                  ),
                  onPressed: () {
