...
class DetailProfiL5 extends StatefulWidget {
  const DetailProfiL5({super.key});

  @override
  State<DetailProfiL5> createState() => _DetailProfiL5State();
}

class _DetailProfiL5State extends State<DetailProfiL5> {
  bool isEditing = false;

  // Data yang bisa diedit
  String nama = 'Cecilion Lancelot, S.ML';
  String jabatan = 'Kasi Kesa';
  String alamat = 'ExPRejo RT 01 RW 02, Desa Legend';
  String pendidikan = 'S1';
  String noTelepon = '081234567890';
  String email = 'Cintasejatiitumrnyakitkand@gmail.com';
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                              image: AssetImage('image/bp cecilion.jpg'),
                              fit: BoxFit.cover,
                            ),
                            border: Border.all(
                              color: Colors.grey,
