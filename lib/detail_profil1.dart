...
class DetailProfil1 extends StatefulWidget {
  const DetailProfil1({super.key});

  @override
  State<DetailProfil1> createState() => _DetailProfil1State();
}

class _DetailProfil1State extends State<DetailProfil1> {
  bool isEditing = false; // Status untuk menentukan apakah dalam mode edit

  // Variabel yang dapat diubah untuk setiap data
  String nama = 'Zilong Aluchard, S.ML';
  ...
  String email = 'callmealucard@gmail.com';
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                              image: AssetImage('image/pak zilong.jpg'),
                              fit: BoxFit.cover,
                            ),
                            border: Border.all(
                              color: Colors.grey,
